...
class UtilTests extends AnyFunSuite:
  ...
  test(testName = "cartesian0") {
    testCartesian(List(), List(List()))
  }

  test(testName = "cartesian1") {
    testCartesian(List(List(), List(10, 20)), List())
  }

  test(testName = "cartesian2") {
    testCartesian(List(List(1, 2), List()), List())
  }

  test(testName = "cartesian3") {
    testCartesian(List(List(1, 2)), List(List(1), List(2)))
  }

  test(testName = "cartesian4") {
    testCartesian(List(List(1), List(10, 20)), List(List(1, 10), List(1, 20)))
  }
